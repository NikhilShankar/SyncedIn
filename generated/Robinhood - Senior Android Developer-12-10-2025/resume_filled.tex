...
\begin{itemize}[leftmargin=0.15in, label={}]
    \normalfont{\item{
     \textbf{Languages: }{Kotlin, Java, Python, Dart, Golang, Swift, C++, C\#} \\
     \textbf{Platforms: }{Android Studio, Firebase, AWS, GCM, IntelliJ, Goland, VSCode, Figma} \\
     \textbf{Skills: }{Modular code using MVVM MVI and Clean Architecture, Complex UI Development using Compose, Design patterns, Multi Module App Design, UI Optimizations, Designing Framework and Libraries, Code Reviews and detecting code smells and bugs, Performance profiling, Google Play Store Management, Project Planning, Mentoring Junior Developers, Agile Planning} \\
     \textbf{Frameworks: }{Android SDK, Jetpack Compose, Retrofit, Coroutines, Dagger, Hilt, NDK, OkHttp, Room, SQLite, Livedata, JUnit, Material Components, Jetpack Libraries, Gradle} \\
     \textbf{Tools: }{Git, AS Profiler, Leak Canary, Debugger, Stetho, Postman, GPU Profiler, Network Profiler, Charles, Benchmark Library} \\
     \textbf{Database: }{SQLite, Firebase Firestore, MySQL, Firebase Realtime, MongoDB, Weaviate-Vector DB}
    }}
\end{itemize}
