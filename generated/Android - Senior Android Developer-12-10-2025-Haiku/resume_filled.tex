...
\begin{itemize}[leftmargin=0.3in]
  ...
  \resumeItem{Integrated detekt and spotless library to enforce coding standards across modules thereby ensuring easier code reviews}
\end{itemize}
...
\begin{itemize}[leftmargin=0.15in, label={}]
    \normalfont{\item{
     ...
     \textbf{Skills: }{Modular code using MVVM MVI and Clean Architecture, Multi Module App Design, Complex UI Development using Compose, UI Optimizations, Designing Framework and Libraries, Agile Planning, OOP, Design patterns, Code Reviews and detecting code smells and bugs, Code refactoring, Mentoring Junior Developers} \\
     \textbf{Frameworks: }{Android SDK, Jetpack Compose, Retrofit, Coroutines, Dagger, Hilt, OkHttp, Room, SQLite, Material Components, Jetpack Libraries} \\
     \textbf{Tools: }{Git, AS Profiler, Leak Canary, Debugger, Postman, Github Actions, Jira, Bitbucket} \\
