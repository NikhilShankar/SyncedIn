...
\begin{itemize}[leftmargin=0.15in, label={}]
    \normalfont{\item{
     \textbf{Languages: }{Kotlin, Java, Python, Dart, Golang, C++, Swift} \\
     \textbf{Platforms: }{Android Studio, Firebase, AWS, IntelliJ, Figma, VSCode} \\
     \textbf{Skills: }{Modular code using MVVM MVI and Clean Architecture, Complex UI Development using Compose, Design patterns, Multi Module App Design, UI Optimizations, Code Reviews and detecting code smells and bugs, Performance profiling, Mentoring Junior Developers, OOP, Agile Planning} \\
     \textbf{Frameworks: }{Android SDK, Jetpack Compose, Retrofit, Coroutines, Dagger, Hilt, Room, OkHttp, Livedata, Material Components, Jetpack Libraries, JUnit, Motion Layout, Gradle} \\
     \textbf{Tools: }{Git, AS Profiler, Leak Canary, Debugger, Postman, Network Profiler, Github Actions, Jira} \\
     \textbf{Database: }{SQLite, Firebase Firestore, Firebase Realtime, MySQL}
    }}
\end{itemize}
