...
\begin{itemize}[leftmargin=0.15in, label={}]
    \normalfont{\item{
     ...
     \textbf{Platforms: }{Android Studio, Firebase, AWS, IntelliJ, VSCode, Figma, PyCharm} \\
     \textbf{Skills: }{Modular code using MVVM MVI and Clean Architecture, Multi Module App Design, Complex UI Development using Compose, UI Optimizations, Design patterns, Code Reviews, Performance profiling, Mentoring Junior Developers, Project Planning, UML Diagrams} \\
     \textbf{Frameworks: }{Android SDK, Jetpack Compose, Retrofit, Coroutines, Dagger, Hilt, OkHttp, Room, Material Components, Jetpack Libraries, JUnit, Gradle} \\
     \textbf{Tools: }{Git, AS Profiler, Debugger, Charles, Github Actions, Jira, Trello, Confluence, Bitbucket} \\
